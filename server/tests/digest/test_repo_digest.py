...
class TestGetEventsBetween:
    ...
    def test_get_events_within_range(self, mock_repo):
        ...
        events = mock_repo.get_events_between(NotificationEvent, start, end)
        assert len(events) == 2
    ...
    def test_get_events_single_day(self, mock_repo):
        ...
        events = mock_repo.get_events_between(
            NotificationEvent, date_filter, date_filter
        )
        assert len(events) == 1
